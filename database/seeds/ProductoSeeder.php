...
class ProductoSeeder extends Seeder
{
    ...
    public function run()
    {
        Db::transaction(function(){
            ...
            $simple = factory(\App\Producto::class)->create(['nombre' => 'simple 1', 'tipo_type' => 'App\Simple', 'tipo_id' => 1]);
            $simple2 = factory(\App\Producto::class)->create(['nombre' => 'simple 2', 'tipo_type' => 'App\Simple', 'tipo_id' => 2]);
